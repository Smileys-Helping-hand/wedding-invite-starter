...
const statusCopy = {
  [RSVP_STATUSES.confirmed]:
    'We are honoured to celebrate with you. Your RSVP is confirmed.',
  [RSVP_STATUSES.pending]:
    'We look forward to your reply. Kindly RSVP at your earliest convenience.',
  [RSVP_STATUSES.declined]:
    'We will miss you dearly, may Allah bless you for your warm wishes.',
};
